...
<a href="index_Leave.php">Back to Table</a>
    ...
    <form action="LeaveForm.php" method="POST" id="searchForm" style="float: right;">
    ...
    <div class="container">
        ...
        <form action="uploadLeave.php" method="post">
            ...
            <label for="specificDates">Specific Dates:</label>
                <input type="text" id="specificDates" name="specificDates" placeholder="format like this: 1,23,24,25">
            ...
            <div class="form-group">
                ...
                <select id="leave_type" name="leave_type" required>
                    ...
                    <option value="Faternity">Maternity</option>
                    <option value="Paternity">Paternity</option>
                    <option value="Solo">Solo Parent</option>
                    <option value="RA9262">RA 9262</option>
                </select>
            </div>
            <div class="form-group">
