...
<a href="index_Leave.php">Back to Table</a>
    ...
    <form action="personalPass.php" method="POST" id="searchForm" style="float: right;">
    ...
    <div class="container">
        <h2>Personal Pass Form</h2>
        <form action="personalPassUpload.php" method="post">
