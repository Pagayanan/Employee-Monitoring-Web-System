...
<tbody class="table-body">
    ...
    <tr>
        ...
        <td colspan="11"><input type="text" name="surname" class="inputToBe" value="<?php echo $surname;?>"></td>

    </tr>
    <tr>
        <td colspan="1" class="s-label border-0"><span class="count"></span> FIRST NAME</td>
        <td colspan="9"><input type="text"  name="firstname" class="inputToBe" value="<?php echo $firstname;?>"></td>
        <td colspan="2" class="align-top s-label"><small>NAME EXTENSION (JR.,SR)</small>
            <div style="width: 22%;display: inline-block;margin-left: 2%;"><input type="text" class="inputToBe" name="nameextension" style=" background: transparent;" value="<?php echo $name_extension;?>"></div>
        </td>
    </tr>
    <tr>
        <td colspan="1" class="s-label border-0"><span class="count"></span> MIDDLE NAME</td>
        <td colspan="11"><input type="text" name="middlename" class="inputToBe" value="<?php echo $middle_name;?>"></td>
    </tr>
    <tr>
        <td colspan="1" class="s-label border-bottom-0">
...
<div style="float: right;"><p class="theFooterParagraphinbelow"><i> CS FORM 212 (Revised 2017), Page 1 of 4</i></p></div>