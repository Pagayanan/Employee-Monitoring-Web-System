...
// Bind parameters to the prepared statement
$stmt_pdsPage2_workExperience->bind_param("ssssssssissss", $inclusiveDatesFrom, $inclusiveDatesTo, $monthlySalary, $positionTitle, $departmentAgencyOffice, $salaryJobPay, $statusOfAppointment, $govService, $referenceWrkexprID,$surname,$firstname,$middlename,$nameextension);

// Initialize referenceWrkexprID variable
...
foreach ($_POST['inclusiveDatesFrom'] as $key => $value) {
    ...
    $referenceWrkexprID = $key + 1; // Assuming referenceWrkexprID starts from 1
