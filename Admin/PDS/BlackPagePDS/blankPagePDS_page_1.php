<table class="" style="border: 4px solid #000;">
    ...
    <tbody class="table-body">
        ...
        <tr>
            ...
            <td colspan="1" class="align-top s-label">
                <div class="nameExtensionCont">
                    ...
                    <div class="nameExtentionBox" style="display: inline-block;">
        ...
        <tr>
            ...
            <td colspan="6" class=" s-label text-danger text-center "><i class="redText"><b>(Continue on seperate sheet if necessary)</b></i></td>
        </tr>
    </tbody>
    ...
    <tbody class="table-body">
        ...
        <tr>
            ...
            <!-- <td colspan="3"><input type="date" name="" id="" class="inputToBe" value=" <?php //echo $rows['26date']; 
                                                                                            ?>  "></td> -->
            <!-- <td colspan="3" rowspan=""><input type="date" name="" id="" class="inputToBe" value="<?php //echo $rows['26date']; 
                                                                                                        ?>"> </td> -->
